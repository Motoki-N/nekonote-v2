...
export type RevisionSuggestionInput = z.infer<
  typeof revisionSuggestionInputSchema
>;
export type RevisionSuggestionUpdate = z.infer<
  typeof revisionSuggestionUpdateSchema
>;
...
export const proofreadSuggestionSchema = z.object({
  original_text: z
    .string()
    .describe(
      "修正対象の箇所。原稿から一字一句そのまま引用する（原稿内で一意に特定できる長さで）",
    ),
